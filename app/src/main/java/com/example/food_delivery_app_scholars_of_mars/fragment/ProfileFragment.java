...
public class ProfileFragment extends Fragment {
    ...
    public void onStart() {
        ...
        address = getActivity().findViewById(R.id.profile_address);
        phoneNumber = getActivity().findViewById(R.id.profile_phone_number);

        SessionManager sessionManager = new SessionManager(getContext());
        HashMap<String, String> user = sessionManager.getUserInfo();
        name.setText(user.get(SessionManager.KEY_FULL_NAME));
        email.setText(user.get(SessionManager.kEY_EMAIL));
        phoneNumber.setText(user.get(SessionManager.KEY_PHONE_NUMBER));
        address.setText(user.get(SessionManager.kEY_ADDRESS));
    }
